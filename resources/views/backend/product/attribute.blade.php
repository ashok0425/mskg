            ...
            <tbody>
                ...
                @foreach ($color as $item)
                    <tr>
                      ...
                      @if ($item->status==1)
                      <a href="{{route('admin.productcolor.deactive',['id'=>$item->id,'table'=>'productcolors'])}}" class="btn btn-primary"><i class="fas fa-thumbs-down"></i></a>
                      @else
                      <a href="{{route('admin.productcolor.active',['id'=>$item->id,'table'=>'productcolors'])}}" class="btn btn-primary"><i class="fas fa-thumbs-up"></i></a> 
                      @endif
            ...
            <tbody>
                ...
                @foreach ($variation as $item)
                    <tr>
                      ...
                      @if ($item->status==1)
                      <a href="{{route('admin.variation.deactive',['id'=>$item->id,'table'=>'productvariations'])}}" class="btn btn-primary"><i class="fas fa-thumbs-down"></i></a>
                      @else
                      <a href="{{route('admin.variation.active',['id'=>$item->id,'table'=>'productvariations'])}}" class="btn btn-primary"><i class="fas fa-thumbs-up"></i></a>
