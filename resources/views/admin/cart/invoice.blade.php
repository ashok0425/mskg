...
.custom-fw-100 {
    font-weight: var(--custom-fw-100);
}
.custom-fw-300 {
    font-weight: var(--custom-fw-300);
}
.custom-fw-500 {
...
table {
    border: 2px solid var(--custom-black) !important;
}

.page {
    border: 2px dashed var(--custom-black);
    padding-bottom: 3rem;
}
@media (max-width: 575px) {
    :root {
        ...
        --custom-fs-13: 13px;
        --custom-fs-14: 14px;
        --custom-fs-16: 13px; /*edited */
        --custom-fs-18: 18px;
        --custom-fs-20: 16px; /*edited */
        --custom-fs-22: 22px;
        --custom-fs-24: 24px;
        --custom-fs-25: 20px; /*edited */
        --custom-fs-28: 28px;
        --custom-fs-30: 25px; /*edited */
        --custom-fs-35: 35px;
        --custom-fs-40: 40px;
        --custom-fs-50: 50px;
        --custom-fs-64: 64px;
...
@endphp
 ...
 <p class="custom-fs-25 custom-fw-500 lh-sm">{{ $vendor->address }}</p>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6  text-end">
                                    <p class="custom-fs-25 custom-fw-700">BILL TO
                                    </p>
                                    <p class="custom-fs-25 custom-fw-500 lh-sm">
                                        {{$ship->name}}
                               <br>
                                  {{$ship->email}}
                                   <br>
                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" class="border border-2 border-dark">Name</th>
                                            ...
                                            <th scope="col" class="border border-2 border-dark"> Net <br>
                                                Amount</th>
                                            <th scope="col" class="border border-2 border-dark"> GST</th>
                                            <th scope="col" class="border border-2 border-dark"> BV</th>
                                    ...
                                    @endphp
                                        <tr>
                                            <td scope='row' class="border border-2 border-dark">{{ $loop->iteration }}</td>
                                            ...
                                            <td class="border border-2 border-dark">{{ __getPriceunit() .$item->price }}</td>
                                            <td class="border border-2 border-dark">{{ $item->qty }}</td>
                                            <td class="border border-2 border-dark">
                                                {{ __getPriceunit(). $net }}
                                            </td>
                                            <td class="border border-2 border-dark">{{ $item->gst }} %</td>
                                            ...
                                            <td class="border border-2 border-dark">{{ __getPriceunit().$total}}</td>
                                        </tr>
                                        @endforeach
