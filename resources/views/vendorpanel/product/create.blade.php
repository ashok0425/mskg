...
<div class="card">
        ...
        <div class="col-md-6">
            ...
            <div class="mb-3">
                ...
                <select name="shop"  class="form-control  " data-text="subcategory" required>
        ...
        <div class="col-md-6">
             ...
             <div class="mb-3">
                <label class="form-label">Price (inc vat)</label>
    ...
    $comission=DB::table('websites')->where('id',1)->value('comission');
        ...
        <div class="col-md-6">
            ...
            <div class="mb-3">
               ...
               <textarea name="material_used" id="summernote4" class="form-control" required>{{ old('short_description') }}</textarea>
               </textarea>
            </div>
            <div class="mb-3">
