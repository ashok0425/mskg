...
<h4>Required field: <span class="text-danger">*</span></h4>
        ...
        <div class="col-md-6">
            ...
            <div class="mb-3">
                ...
                <select name="shop"  class="form-control  " data-text="subcategory" >
                    <option value="" disabled>--select Shop---</option>
                    @foreach ($shop as $item)
                    <option value="{{$item->id}}"  @if ($item->id==$product->shop_id)
                        selected
        ...
        <div class="col-md-6">
            ...
            <div class="mb-3">
               ...
               <label class="form-label">Price After Adding {{ $product->comission }}% Commission</label>
       ...
       <div class="col-md-6">
        ...
        <div class="col-md-6">
            ...
            <div class="mb-3">
               ...
               <textarea name="material_used" id="summernote4" class="form-control" >{{$product->material }}</textarea>
               </textarea>
            </div>
            <div class="mb-3">
           ...
           <div class="row my-3">
               <div class="col-md-4 col-6">
                ...
                @else 
                <div class="text-danger">Only available for Members. </div>
                @endif
            <br>
